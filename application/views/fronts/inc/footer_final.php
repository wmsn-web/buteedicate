                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <h5>
                                ...
                                <?= nbs(5); ?>
                                 <span class="text-info"><i class="fas fa-envelope-open-text"></i>
                                    <a class="text-info" href="mailto:info@byteducate.com">Email</a>
                                 </span>
                            </h5>
                            <img src="<?= base_url('assets/img/baner/footerlogo.png'); ?>" alt="logo" class="img-responsive mt-5"><br>
