		...
		<div class="main-content app-content">
			...
			<div class="container-fluid"> 
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Terms & Condition</h4>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								<form action="<?= base_url('auth/admin/Terms_Condition/updateTerms'); ?>" method="post">
									<div class="form-group">
										<textarea name="terms" id="editor1" required="required"><?= $terms['trems_details']; ?></textarea>
									</div>
									<div class="form-group">
